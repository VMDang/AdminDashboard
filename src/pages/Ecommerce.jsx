...
import { earningData, SparklineAreaData, ecomPieChartData, dropdownData,
    recentTransactions, weeklyStats, medicalproBranding
} from "../data/dummy";
import { useStateContext } from "../contexts/ContextProvider";

const DropDown = ({ currentMode }) => (
    <div className={"w-28 border-1 border-color px-2 py-1 rounded-md"}>
        <DropDownListComponent id={"time"} fields={{ text: 'Time', value: 'Id' }} style={{border: 'none', color: (currentMode === 'Dark') && 'white'}}
        ...
        <HelmetProvider>
            ...
            <div className={"mt-12"}>
                <div className={"flex flex-wrap lg:flex-nowrap justify-center"}>
                    <div className={"bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 bg" +
                    ...
                    <div className={"flex m-3 flex-wrap justify-center gap-1 items-center "}>
                        {
                            earningData.map((item) => (
                                <div key={item.title} className={"bg-blue-100 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl"}>
                    ...
                    <div className={"bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780"}>
                        ...
                        <div className={"mt-10 flex gap-10 flex-wrap justify-center"}>
                            <div className={"border-r-1 border-color m-4 pr-10"}>
                                ...
                                <div className={"mt-5"}>
                                    <SparkLine id={"line-sparkline"} type={"Line"} height={"80px"} width={"250px"}
                                               data={SparklineAreaData} color={currentColor} currentColor={currentColor} />
                                </div>
                                <div className={"mt-10"}>
                            ...
                            <div className={""}>
                                <Stacked width={"320px"} height={"360px"} currenMode={currentMode}/>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className={"rounded-2xl md:w-400 p-4 m-3"} style={{ backgroundColor: currentColor}}>
                            <div className={"flex justify-between items-center"}>
                                ...
                                <div>
                                    <p className={"text-2xl text-white font-semibold mt-8"}> $33,969.93 </p>
                        ...
                        <div className={"bg-white dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-8 m-3 flex justify-center items-center gap-10"}>
                            <div>
                                <p className={"text-2xl font-semibold"}>$68,246</p>
                ...
                <div className={"flex gap-10 m-4 flex-wrap justify-center"}>
                    <div className={"bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl"}>
                        <div className={"flex justify-between items-center gap-2"}>
                            <p className={"text-xl font-semibold"}> Recent Transaction</p>
                ...
                <div className={"flex flex-wrap justify-center"}>
                    <div className={"md:w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3"}>
                        <div className={"flex justify-between"}>
                            ...
                            <button className={"text-xl font-semibold text-gray-500"} type={"button"}>
                                <IoIosMore/>
                            </button>
                        </div>
                        <div className={"mt-10"}>
